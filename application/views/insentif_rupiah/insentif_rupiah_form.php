...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Insentif_rupiah <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="int">Insentif <?php echo form_error('insentif') ?></label>
	    ...
	    <a href="<?php echo site_url('insentif_rupiah') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>