        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "sales_mentah/json", "type": "POST"},
                    columns: [
                        {
                            "data": "npp",
                            "orderable": false
                        },{"data": "sales_name"},{"data": "sales_type"},{"data": "officeID"},{"data": "activedate"},{"data": "grade"},{"data": "status"},{"data": "upliner_npp"},{"data": "keterangan"},{"data": "non_activedate"},{"data": "address"},{"data": "phone"},{"data": "last_updatetime"},
                        {
                            "data" : "action",
                            "orderable": false,
