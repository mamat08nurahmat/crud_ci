...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            <label for="enum">Is Blokir <?php echo form_error('is_blokir') ?></label>
            <input type="text" class="form-control" name="is_blokir" id="is_blokir" placeholder="Is Blokir" value="<?php echo $is_blokir; ?>" />
        </div>
	    <div class="form-group">
