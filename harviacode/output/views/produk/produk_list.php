    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('produk/read/'.$produk->kd_produk),'Read'); 
				echo ' | '; 
				echo anchor(site_url('produk/update/'.$produk->kd_produk),'Update'); 
				echo ' | '; 
				echo anchor(site_url('produk/delete/'.$produk->kd_produk),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
