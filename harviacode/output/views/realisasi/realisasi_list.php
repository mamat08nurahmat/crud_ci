...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $realisasi->nominal ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('realisasi/read/'.$realisasi->npp),'Read'); 
				echo ' | '; 
				echo anchor(site_url('realisasi/update/'.$realisasi->npp),'Update'); 
				echo ' | '; 
				echo anchor(site_url('realisasi/delete/'.$realisasi->npp),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('realisasi/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
